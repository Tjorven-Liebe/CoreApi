...
public class Prefix {
    ...
    public static String offline(String player) { return pre() + Message.get("offlineplayer", "&cDer Spieler &b%playername% &cist &noffline &r&coder &nexistiert &r&cnicht!").replace("%playername%", player); }
